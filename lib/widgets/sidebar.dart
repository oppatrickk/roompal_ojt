...
class SideBar extends StatefulWidget {
  const SideBar({super.key, required this.isRenter});
  final bool isRenter;
...
class _SideBarState extends State<SideBar> {
  ...
  Widget build(BuildContext context) {
    ...
    int selectedIndex = sideBarState.selectedIndex;
    ...
    ListTile buildListTile(
      ...
      return ListTile(
        ...
        selected: isSelected,
        selectedTileColor: const Color(0xFF96A9CC),
      );
    }
    ...
    return Padding(
      ...
      child: TextButton(
        ...
        style: ButtonStyle(
            ...
            padding: const MaterialStatePropertyAll<EdgeInsetsGeometry>(EdgeInsetsDirectional.symmetric(vertical: 15))),
        child: const Center(
          child: Text(
            'Log out',
